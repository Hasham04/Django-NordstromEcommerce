...
class Order(models.Model):
    ...
    def get_raw_total(self):
        ...
        subtotal = subtotal - (subtotal*(self.coupon.amount/100))
        print(subtotal)
        return subtotal
...
class Comment(models.Model):
   ...
   # dislikes= models.IntegerField()
    reply = models.ForeignKey('self',blank=True,null=True, related_name='replies', on_delete=models.DO_NOTHING)
    def __str__(self):
        return f'{self.product.title}-{str(self.user.username)}'
